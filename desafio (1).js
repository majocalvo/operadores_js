...
console.log(redondearHaciaArriba(50.1))
...
function esPositivo(numero) {
  ...
  return numero >= 1? "Es positivo": numero == 0? false: "Es negativo";
...
console.log(combinarNombres('Renata','Gonzalez'))
